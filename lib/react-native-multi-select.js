...
export default class MultiSelect extends Component {
  static propTypes = {
    ...
    additionalFontSize: PropTypes.number,
  ...
  static defaultProps = {
    ...
    displayKey: 'name',
    additionalKey: '',
    additionalFontSize: 12,
    additionalTextColor: colorPack.textPrimary,
  ...
  _getSelectLabel = () => {
    const { selectText, single, selectedItems, displayKey, additionalKey } = this.props;
  ...
  _getRow = item => {
    const { selectedItemIconColor, displayKey, additionalKey } = this.props;
    return (
      <TouchableOpacity
